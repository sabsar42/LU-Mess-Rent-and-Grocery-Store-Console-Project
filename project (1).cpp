...
void std_route_one(int ni)
{
    ...
    r_one_add.open(point_r_one + ".txt");    //open the typed point file  i.e: Tilaghor.txt
    {
        ...
        while (r_one_add >> r1_serial >> r1_add >> r1_room >> r1_seat)
        {
            if (r1_seat >= ni)
            {
    ...
    r_one_adds.open(point_r_one + ".txt");
    {
        ...
        while (r_one_adds >> r1_serial >> r1_add >> r1_room >> r1_seat)
...
void std_route_four(int ni)
{
    ...
    r_four_add.open(point_r_four + ".txt");
    {
        ...
        while (r_four_add >> r1_add >> r1_room >> r1_seat)
        {
            if (r1_seat >= ni)
            {
                // searches meess seat based on user input
...
void own_route1()
{
...

    {
        ...
        messe<<pro1.serial_no+1<<" "<<pro1.address<<" "<<pro1.room<<" "<<pro1.seat_no<<" "<<pro1.price;
    }
